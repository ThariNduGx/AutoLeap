...
export async function GET(request: NextRequest) {
    try {
        ...
        const { data: business, error } = await (supabase
            ...
            .select('id, name, telegram_bot_token, fb_page_id, fb_page_name, owner_telegram_chat_id, google_calendar_token, google_calendar_email, timezone, business_hours, cancellation_window_hours')
...
export async function PATCH(request: NextRequest) {
    try {
        ...
        const allowed = ['owner_telegram_chat_id', 'name', 'phone', 'timezone', 'business_hours', 'cancellation_window_hours'] as const;
