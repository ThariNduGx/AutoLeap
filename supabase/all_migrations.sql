...
-- >>> BEGIN 002_create_users_table.sql
...
-- <<< END 002_create_users_table.sql

-- >>> BEGIN 20260112181500_create_appointments_table.sql
...
-- <<< END 20260112181500_create_appointments_table.sql

-- >>> BEGIN 20260112182500_create_business_costs.sql
...
-- <<< END 20260112182500_create_business_costs.sql

-- >>> BEGIN 20260112194000_match_faqs_gemini.sql
...
-- <<< END 20260112194000_match_faqs_gemini.sql

-- >>> BEGIN 20260119_add_facebook_messenger_fields.sql
...
-- <<< END 20260119_add_facebook_messenger_fields.sql

-- >>> BEGIN 20260119120000_add_user_roles_and_business_link.sql
...
-- <<< END 20260119120000_add_user_roles_and_business_link.sql

-- >>> BEGIN 20260319_enhancements.sql
...
-- <<< END 20260319_enhancements.sql

-- >>> BEGIN 20260319_security_and_perf.sql
...
-- <<< END 20260319_security_and_perf.sql

-- >>> BEGIN 20260320_appointment_reminders.sql
...
-- <<< END 20260320_appointment_reminders.sql

-- >>> BEGIN 20260320_budgets_and_cost_logs.sql
...
-- <<< END 20260320_budgets_and_cost_logs.sql

-- >>> BEGIN 20260320_conversations_and_queue_fix.sql
...
-- <<< END 20260320_conversations_and_queue_fix.sql

-- >>> BEGIN 20260320_dead_letter_queue_and_budget_alerts.sql
...
-- <<< END 20260320_dead_letter_queue_and_budget_alerts.sql

-- >>> BEGIN 20260320_faq_hit_count.sql
...
-- <<< END 20260320_faq_hit_count.sql

-- >>> BEGIN 20260320_fix_appointment_status_default.sql
...
-- <<< END 20260320_fix_appointment_status_default.sql

-- >>> BEGIN 20260320_timezone_email_cleanup.sql
...
-- <<< END 20260320_timezone_email_cleanup.sql

-- >>> BEGIN 20260320_webhook_idempotency.sql
...
-- <<< END 20260320_webhook_idempotency.sql

-- >>> BEGIN 20260321_rls_and_indexes_audit.sql
...
-- <<< END 20260321_rls_and_indexes_audit.sql

-- >>> BEGIN 20260321_waitlist_services_notes.sql
...
-- <<< END 20260321_waitlist_services_notes.sql

-- >>> BEGIN 20260322_service_tiers.sql
...
-- <<< END 20260322_service_tiers.sql

-- >>> BEGIN 20260322_workflow_improvements.sql
...
-- <<< END 20260322_workflow_improvements.sql

-- >>> BEGIN 20260323_platform_settings.sql
...
-- <<< END 20260323_platform_settings.sql

-- >>> BEGIN 20260324_reviews_unique_constraint.sql
...
-- <<< END 20260324_reviews_unique_constraint.sql

-- >>> BEGIN 20260325_match_faqs_openai.sql
...
-- <<< END 20260325_match_faqs_openai.sql

-- >>> BEGIN 20260326_budget_fixes.sql
...
-- <<< END 20260326_budget_fixes.sql

-- >>> BEGIN 20260326_faq_dedup.sql
...
-- <<< END 20260326_faq_dedup.sql

-- >>> BEGIN 20260327_rag_fixes.sql
...
-- <<< END 20260327_rag_fixes.sql

-- >>> BEGIN 20260328_appointments_updated_at.sql
...
-- <<< END 20260328_appointments_updated_at.sql
